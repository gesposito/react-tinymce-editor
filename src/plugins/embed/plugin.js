...
tinymce.PluginManager.add('embed', function(editor, url) {
	var urlPatterns = [
		{ regex: /(.*(ai|avi|flv|mov|pdf|psd|wmv)$)/gi, type: 'iframe', w: 480, h: 360, url: '//docs.google.com/viewer?embedded=true&url=$0', allowFullscreen: true },
		{ regex: /(.*(doc|docx|ppt|pptx|xls|xlsx)$)/gi, type: 'iframe', w: 480, h: 360, url: '//view.officeapps.live.com/op/embed.aspx?src=$0', allowFullscreen: true },
	];
	...
	function showDialog() {
		...
		//
		editor.namespaced.getEmbedData = getData;
		editor.namespaced.getEmbedHTML = dataToHtml;

		// win = editor.windowManager.open(
		// Shows an external Dialog
		editor.namespaced.showEmbedDialog({
	...
	editor.addButton('embed', {
		tooltip: 'Insert/edit embeddable content',
		onclick: showDialog,
	...
	editor.addMenuItem('embed', {
		icon: 'newdocument',
		text: 'Insert/edit embeddable content',
		onclick: showDialog,
		context: 'insert',
	...
	editor.addCommand('mceEmbed', showDialog);
